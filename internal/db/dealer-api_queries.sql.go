...
// Arguments: city_id
func (q *Queries) GetAreasByCityID(ctx context.Context, cityID pgtype.Int4) ([]TblArea, error) {
	rows, err := q.db.Query(ctx, getAreasByCityID, cityID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
// Arguments: region_id
func (q *Queries) GetCitiesByRegionID(ctx context.Context, regionID pgtype.Int4) ([]TblCity, error) {
	rows, err := q.db.Query(ctx, getCitiesByRegionID, regionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
// Arguments: country_id
func (q *Queries) GetRegionsByCountryID(ctx context.Context, countryID pgtype.Int4) ([]TblRegion, error) {
